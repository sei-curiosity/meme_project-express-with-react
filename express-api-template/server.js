...
var textapi = new AYLIENTextAPI({
  application_id: "caf190f1",
  application_key: "761c68d7fdacd2116a31741ffd92033d"
});
textapi.sentiment({'text': 'I love myself and i hate all the people'}, function(error, response) {
  if (error === null) {
